...
namespace ControleDeDespesas.Services
{
    public class UsuarioService
    {
        ...
        public async Task Cadastra(CreateUsuarioDto dto)
        {
            ...
            {
                throw new ApplicationException("Falha ao criar usuario");
            }
        }
        ...
        public async Task<string> Login(LoginUsuarioDto dto)
        {
            ...
            if (!resultado.Succeeded)
            {
                //Logger.CreateLog("Usuario não autenticado", Enums.LogType.INFO, "UserAutentication");
            ...
            var usuario = _signInManager
                .UserManager
                .Users
                .FirstOrDefault(UserManager => UserManager.NormalizedUserName == dto.Username.ToUpper());
